<template>
  ...
  <h3>En vigueur au 28/09/2020</h3>
<p>
...
http://todokids.com se réserve le droit de modifier unilatéralement et à tout moment le contenu des présentes CGU.</p>

<h3>Article 1 : Les mentions légales</h3>
<p>L’édition et la direction de la publication du site http://todokids.com est assurée par Hussong Laurine, domicilié 3 place marie curie 57280 Semécourt.
Numéro de téléphone est 0687965148
Adresse e-mail laurine.hussong@hotmail.fr.
L'hébergeur du site http://todokids.com est la société _______________, dont le siège social est situé au _______________, avec le numéro de téléphone : _______________.</p>
<h3>ARTICLE 2 : Accès au site</h3>
<p>Le site http://todokids.com permet à l'Utilisateur un accès gratuit aux services suivants :
Le site internet propose les services suivants :
Aide à la planification familiale , To do list  renseignement événement ou rendez-vous
...
Tout événement dû à un cas de force majeure ayant pour conséquence un dysfonctionnement du site ou serveur et sous réserve de toute interruption ou modification en cas de maintenance, n'engage pas la responsabilité de http://todokids.com. Dans ces cas, l’Utilisateur accepte ainsi ne pas tenir rigueur à l’éditeur de toute interruption ou suspension de service, même sans préavis.
...
·         par mail à l'adresse mail laurine.hussong@hotmail.fr
...
<p>Les sources des informations diffusées sur le site http://todokids.com sont réputées fiables mais le site ne garantit pas qu’il soit exempt de défauts, d’erreurs ou d’omissions.
Les informations communiquées sont présentées à titre indicatif et général sans valeur contractuelle. Malgré des mises à jour régulières, le site http://todokids.com ne peut être tenu responsable de la modification des dispositions administratives et juridiques survenant après la publication. De même, le site ne peut être tenue responsable de l’utilisation et de l’interprétation de l’information contenue dans ce site.
...
Le site http://todokids.com ne peut être tenu pour responsable d’éventuels virus qui pourraient infecter l’ordinateur ou tout matériel informatique de l’Internaute, suite à une utilisation, à l’accès, ou au téléchargement provenant de ce site.
...
<p>Des liens hypertextes peuvent être présents sur le site. L’Utilisateur est informé qu’en cliquant sur ces liens, il sortira du site http://todokids.com. Ce dernier n’a pas de contrôle sur les pages web sur lesquelles aboutissent ces liens et ne saurait, en aucun cas, être responsable de leur contenu.</p>
...
L’information contenue dans les cookies est utilisée pour améliorer le site http://todokids.com.
